...
namespace TarodevController {
    public class PlayerInput : MonoBehaviour {
        ...
        private FrameInput Gather() {
            return new FrameInput {
                JumpDown = Input.GetButtonDown("Jump") || Input.GetKeyDown(KeyCode.L),
                JumpHeld = Input.GetButton("Jump") || Input.GetKey(KeyCode.L),
                DashDown = Input.GetKeyDown(KeyCode.J),
                AttackDown = Input.GetKeyDown(KeyCode.K),
